...
* *a new collective:* **Supporters of Collective Intelligence/ SCI**
   ...
   * [Agreement-Based Governance](https://docs.google.com/document/d/1c_xWEIay-2jyJ3Rqb6OgTxoZBJfjNW4d6w6ukXyeJk4/edit?usp=sharing) may function as the general governance recipe (and template) for SCI's governance structure.  However, the SCI members should create a specific consent-based governance plan (constitution).
...
* *another new collective:*  **Supporters of Open Intermedia Commons/SOIC**
   ...
   * SOIC's governing structure may mirror the structure of SCI.  (It may develop a different, but overlapping, team of governing agents.)
